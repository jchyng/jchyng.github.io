...
export default function GalleryView({ projects }: { projects: ProjectData[] }) {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center">
      ...
      {/* Filter tabs */}
      <div className="w-full flex justify-center pt-16 sm:pt-20 pb-4 px-4">
        <div className="flex gap-2 p-1 bg-neutral-900/60 backdrop-blur-sm border border-neutral-800/60 rounded-full">
      ...
      {filteredProjects.length === 0 ? (
        <div className="flex-1 flex items-center justify-center">
          <p className="text-neutral-500">해당 프로젝트가 없습니다.</p>
        </div>
      ) : (
        <div className="w-full flex-1 flex items-center">
          <div className="w-full max-w-6xl mx-auto px-4 sm:px-8 md:px-16 py-8 sm:py-12 flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-24">
